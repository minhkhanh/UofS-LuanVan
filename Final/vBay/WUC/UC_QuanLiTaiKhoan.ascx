...
<div id="QuanLiTaiKhoan_MainContent">
    ...
    <div id="QuanLiTaiKhoan_MainLockDiv">
        ...
        <br />
        <asp:Label ID="Label4" runat="server" Text="Thời hạn khóa:" Width="40%"></asp:Label>
    ...
    <div id="QuanLiTaiKhoan_LockedDiv">
        <center>
            <asp:Label ID="Label6" runat="server" 
                Text="DANH SÁCH CÁC TÀI KHOẢN ĐANG BỊ KHÓA" Font-Bold="True" 
        ...
        <asp:Label ID="Label1" runat="server" Text="Chọn tài khoản cần Unlock:" 
            Font-Bold="True" Width="40%"></asp:Label>
