...
public class ThemThuMucServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ThemThuMucServlet() {
        super();
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (hanhDong.compareTo("them")==0) {
			...
			if (tenDiaDiem!=null && strIdFolder!=null) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/tilesjsp/them-thu-muc.jsp");
