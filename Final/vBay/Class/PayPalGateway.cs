...
using vBay.com.paypal.sandbox.www;
...
namespace vBay
{
    ...
    /*
    public PayPalReturn e1_GetToken(string eMail, decimal amount, string returnUrl, string cancelUrl)
    {
        //PayPal Return Structure
        PayPalReturn rv = new PayPalReturn();
        rv.IsSucess = false;
        ...
        request.SetExpressCheckoutRequest.Version = "51.0";
        request.SetExpressCheckoutRequest.SetExpressCheckoutRequestDetails = new SetExpressCheckoutRequestDetailsType();
        request.SetExpressCheckoutRequest.SetExpressCheckoutRequestDetails.BuyerEmail
